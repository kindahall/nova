...
const windowRegistry: Record<WindowKey, { label: string; subtitle: string; icon: ComponentType<{ size?: number }> }> = {
  ...
  weather: { label: "Weather", subtitle: "Local forecast and conditions", icon: CloudSun },
  notes: { label: "Notes", subtitle: "Local notebook", icon: NotebookPen },
  calculator: { label: "Calculator", subtitle: "Quick math utility", icon: Calculator },
